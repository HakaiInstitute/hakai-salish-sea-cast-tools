...
var_to_dataset_id = {
    "temperature": "ubcSSg3DPhysicsFields1hV21-11",
    "salinity": "ubcSSg3DPhysicsFields1hV21-11",
...
def get_model_data(
    ...
    time,
    nc_output_file,
    server= SALISHSEACAST_ERDDAP,
    datasetID=None,
    depth: slice = slice(0.5000003, 0.5000003),
    gridY: slice = slice(600, 897),
    gridX: slice = slice(100, 300),
):
    subset = (
